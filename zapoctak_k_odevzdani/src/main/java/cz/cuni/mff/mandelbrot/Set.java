...
class Set {
	 ...
	 * A new array is constructed due to it is ready to provides resizing of canvas in GUI.
	 */
	...
	private static void fillCanvas() {
		...
		executor = new ThreadPoolExecutor(pocetjader+4,
				pocetjader + pocetjader, 1,
